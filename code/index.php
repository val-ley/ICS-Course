...
<body>
	...
	<div class="fancy" style="border-color: rgb(54, 54, 54)">
		...
		<a href="activity-1-9" class="cool">Activity 1.9</a><br /><br><br>
		<a href="activity-2-1" class="cool">Activity 2.1</a><br /><br>
		<a href="grid-layout" class="cool">Grid Layout</a><br /><br>
		<a href="introduction-to-php" class="cool">Intro to PHP</a><br /><br>
		<a href="php-variables-lesson" class="cool">PHP Variables Lesson</a><br /><br>
		<a href="php-variables-lesson-2" class="cool">PHP Variables Lesson 2</a><br /><br>
		<a href="activity-2-2" class="cool">Activity 2.2</a><br /><br>
	</div>
